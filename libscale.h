#ifndef HALIDE__libscale_h
#define HALIDE__libscale_h
#include <stdint.h>
...
int scale(struct halide_buffer_t *_src_buffer, int32_t _width, int32_t _height, int32_t _scale_width, int32_t _scale_height, struct halide_buffer_t *_out_buffer);
